    ...
    <div className="space-y-6">
      ...
      <div className="card card-body">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-slate-400 italic shrink-0">Heuristic estimates — not derived from Meridian posterior</span>
        </div>
      ...
      <div>
        <div className="flex items-center gap-2 mb-1">
          <h3 className="font-bold text-slate-900">Cross-channel effects you can't see in standard attribution</h3>
          <span className="text-xs text-slate-400 italic shrink-0">Heuristic estimates — not derived from Meridian posterior</span>
        </div>
      ...
      <div className="card card-body bg-brand-50 border-brand-100">
        <div className="flex items-center gap-2 mb-3">
          <h3 className="font-bold text-brand-900">Recommended next actions</h3>
          <span className="text-xs text-brand-400 italic shrink-0">Heuristic estimates — not derived from Meridian posterior</span>
        </div>
